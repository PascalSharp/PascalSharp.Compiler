...
//            return false;
        ...
        public class ResultNodesSearcher : WalkingVisitorNew // Нигде в проекте не используется потому что expr могут использовать локальные переменные, тип которых неизвестен до семантического разбора
        {
