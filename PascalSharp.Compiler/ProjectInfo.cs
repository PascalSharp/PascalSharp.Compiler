...
namespace PascalSharp.Compiler
{
	public class ProjectInfo : IProjectInfo
	{
		...
		private ProjectType _project_type;
		...
		public IReferenceInfo[] References
		{
			get
			{
		...
		public IResourceInfo[] Resources
		{
			get
			{
	...
	public class SourceCodeFileInfo : IFileInfo
	{
		private string _name;
		private string _path;
