...
namespace PascalSharp.Compiler
{
    ...
    public class RemoteCompilerError : CompilationErrorWithLocation
    {
        string msg;
    ...
    public class RemoteCompilerWarning : CompilerWarning
    {
        string msg;
        location loc;
    ...
    public class RemoteCompiler: ICompiler
    {
        ...
        void stringRecived(string id, string line)
        {
            string arg = null;
            if (line.Length < 3)
                return;
        ...
        void sendCompilerOptions()
        {
            ...
            foreach (CompilerOptions.StandartModule sm in compilerOptions.StandartModules)
                sendCommand(
