...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugValueEnum
	{
		...
		private Interop.CorDebug.ICorDebugValueEnum wrappedObject;
		
		internal Interop.CorDebug.ICorDebugValueEnum WrappedObject
		{
			get
			{
		...
		public ICorDebugValueEnum(Interop.CorDebug.ICorDebugValueEnum wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugValueEnum));
		}
		
		public static ICorDebugValueEnum Wrap(Interop.CorDebug.ICorDebugValueEnum objectToWrap)
		{
