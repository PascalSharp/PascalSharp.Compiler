...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugFunction2
	{
		...
		private Interop.CorDebug.ICorDebugFunction2 wrappedObject;
		
		internal Interop.CorDebug.ICorDebugFunction2 WrappedObject
		{
			get
			{
		...
		public ICorDebugFunction2(Interop.CorDebug.ICorDebugFunction2 wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugFunction2));
		}
		
		public static ICorDebugFunction2 Wrap(Interop.CorDebug.ICorDebugFunction2 objectToWrap)
		{
		...
		public ICorDebugCodeEnum EnumerateNativeCode()
		{
			...
			Interop.CorDebug.ICorDebugCodeEnum out_ppCodeEnum;
