...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugBreakpointEnum
	{
		...
		private Interop.CorDebug.ICorDebugBreakpointEnum wrappedObject;
		
		internal Interop.CorDebug.ICorDebugBreakpointEnum WrappedObject
		{
			get
			{
		...
		public ICorDebugBreakpointEnum(Interop.CorDebug.ICorDebugBreakpointEnum wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugBreakpointEnum));
		}
		
		public static ICorDebugBreakpointEnum Wrap(Interop.CorDebug.ICorDebugBreakpointEnum objectToWrap)
		{
