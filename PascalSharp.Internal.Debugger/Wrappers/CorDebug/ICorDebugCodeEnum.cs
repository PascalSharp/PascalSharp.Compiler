...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugCodeEnum
	{
		...
		private Interop.CorDebug.ICorDebugCodeEnum wrappedObject;
		
		internal Interop.CorDebug.ICorDebugCodeEnum WrappedObject
		{
			get
			{
		...
		public ICorDebugCodeEnum(Interop.CorDebug.ICorDebugCodeEnum wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugCodeEnum));
		}
		
		public static ICorDebugCodeEnum Wrap(Interop.CorDebug.ICorDebugCodeEnum objectToWrap)
		{
