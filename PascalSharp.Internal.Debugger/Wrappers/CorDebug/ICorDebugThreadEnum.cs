...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugThreadEnum
	{
		...
		private Interop.CorDebug.ICorDebugThreadEnum wrappedObject;
		
		internal Interop.CorDebug.ICorDebugThreadEnum WrappedObject
		{
			get
			{
		...
		public ICorDebugThreadEnum(Interop.CorDebug.ICorDebugThreadEnum wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugThreadEnum));
		}
		
		public static ICorDebugThreadEnum Wrap(Interop.CorDebug.ICorDebugThreadEnum objectToWrap)
		{
