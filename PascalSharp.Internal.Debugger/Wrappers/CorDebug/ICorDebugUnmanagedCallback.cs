...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugUnmanagedCallback
	{
		...
		private Interop.CorDebug.ICorDebugUnmanagedCallback wrappedObject;
		
		internal Interop.CorDebug.ICorDebugUnmanagedCallback WrappedObject
		{
			get
			{
		...
		public ICorDebugUnmanagedCallback(Interop.CorDebug.ICorDebugUnmanagedCallback wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugUnmanagedCallback));
		}
		
		public static ICorDebugUnmanagedCallback Wrap(Interop.CorDebug.ICorDebugUnmanagedCallback objectToWrap)
		{
