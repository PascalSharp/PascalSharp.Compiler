...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugErrorInfoEnum
	{
		...
		private Interop.CorDebug.ICorDebugErrorInfoEnum wrappedObject;
		
		internal Interop.CorDebug.ICorDebugErrorInfoEnum WrappedObject
		{
			get
			{
		...
		public ICorDebugErrorInfoEnum(Interop.CorDebug.ICorDebugErrorInfoEnum wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugErrorInfoEnum));
		}
		
		public static ICorDebugErrorInfoEnum Wrap(Interop.CorDebug.ICorDebugErrorInfoEnum objectToWrap)
		{
