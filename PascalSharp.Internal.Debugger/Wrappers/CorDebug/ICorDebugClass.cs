...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugClass
	{
		...
		private Interop.CorDebug.ICorDebugClass wrappedObject;
		
		internal Interop.CorDebug.ICorDebugClass WrappedObject
		{
			get
			{
		...
		public ICorDebugClass(Interop.CorDebug.ICorDebugClass wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugClass));
		}
		
		public static ICorDebugClass Wrap(Interop.CorDebug.ICorDebugClass objectToWrap)
		{
		...
		public Wrappers.CorDebug.ICorDebugModule Module
		{
			get
			{
				Wrappers.CorDebug.ICorDebugModule pModule;
				Interop.CorDebug.ICorDebugModule out_pModule;
