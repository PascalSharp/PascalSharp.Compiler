...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugController
	{
		...
		private Interop.CorDebug.ICorDebugController wrappedObject;
		
		internal Interop.CorDebug.ICorDebugController WrappedObject
		{
			get
			{
		...
		public ICorDebugController(Interop.CorDebug.ICorDebugController wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugController));
		}
		
		public static ICorDebugController Wrap(Interop.CorDebug.ICorDebugController objectToWrap)
		{
