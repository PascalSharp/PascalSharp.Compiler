...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ISequentialStream
	{
		...
		private Interop.CorDebug.ISequentialStream wrappedObject;
		
		internal Interop.CorDebug.ISequentialStream WrappedObject
		{
			get
			{
		...
		public ISequentialStream(Interop.CorDebug.ISequentialStream wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ISequentialStream));
		}
		
		public static ISequentialStream Wrap(Interop.CorDebug.ISequentialStream objectToWrap)
		{
