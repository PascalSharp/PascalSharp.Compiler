...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugContext
	{
		...
		private Interop.CorDebug.ICorDebugContext wrappedObject;
		
		internal Interop.CorDebug.ICorDebugContext WrappedObject
		{
			get
			{
		...
		public ICorDebugContext(Interop.CorDebug.ICorDebugContext wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugContext));
		}
		
		public static ICorDebugContext Wrap(Interop.CorDebug.ICorDebugContext objectToWrap)
		{
