...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugAppDomain
	{
		...
		private Interop.CorDebug.ICorDebugAppDomain wrappedObject;
		
		internal Interop.CorDebug.ICorDebugAppDomain WrappedObject
		{
			get
			{
		...
		public ICorDebugAppDomain(Interop.CorDebug.ICorDebugAppDomain wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugAppDomain));
		}
		
		public static ICorDebugAppDomain Wrap(Interop.CorDebug.ICorDebugAppDomain objectToWrap)
		{
		...
		public ICorDebugThreadEnum EnumerateThreads()
		{
			...
			Interop.CorDebug.ICorDebugThreadEnum out_ppThreads;
		...
		{
			this.WrappedObject.SetAllThreadsDebugState(((Interop.CorDebug.CorDebugThreadState)(state)), pExceptThisThread.WrappedObject);
		}
		...
		public ICorDebugErrorInfoEnum CanCommitChanges(uint cSnapshots, ref ICorDebugEditAndContinueSnapshot pSnapshots)
		{
			...
			Interop.CorDebug.ICorDebugEditAndContinueSnapshot ref_pSnapshots = pSnapshots.WrappedObject;
			Interop.CorDebug.ICorDebugErrorInfoEnum out_pError;
		...
		public ICorDebugAssemblyEnum EnumerateAssemblies()
		{
			...
			Interop.CorDebug.ICorDebugAssemblyEnum out_ppAssemblies;
			this.WrappedObject.EnumerateAssemblies(out out_ppAssemblies);
			ppAssemblies = ICorDebugAssemblyEnum.Wrap(out_ppAssemblies);
			return ppAssemblies;
		}
		
		public Wrappers.CorDebug.ICorDebugModule GetModuleFromMetaDataInterface(object pIMetaData)
		{
		...
		public ICorDebugBreakpointEnum EnumerateBreakpoints()
		{
			...
			Interop.CorDebug.ICorDebugBreakpointEnum out_ppBreakpoints;
		...
		public ICorDebugStepperEnum EnumerateSteppers()
		{
			...
			Interop.CorDebug.ICorDebugStepperEnum out_ppSteppers;
