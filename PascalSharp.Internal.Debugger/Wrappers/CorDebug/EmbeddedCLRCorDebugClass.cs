...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class EmbeddedCLRCorDebugClass
	{
		...
		private Interop.CorDebug.EmbeddedCLRCorDebugClass wrappedObject;
		
		internal Interop.CorDebug.EmbeddedCLRCorDebugClass WrappedObject
		{
			get
			{
		...
		public EmbeddedCLRCorDebugClass(Interop.CorDebug.EmbeddedCLRCorDebugClass wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(EmbeddedCLRCorDebugClass));
		}
		
		public static EmbeddedCLRCorDebugClass Wrap(Interop.CorDebug.EmbeddedCLRCorDebugClass objectToWrap)
		{
