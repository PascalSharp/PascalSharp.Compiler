...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugArrayValue
	{
		...
		private Interop.CorDebug.ICorDebugArrayValue wrappedObject;
		
		internal Interop.CorDebug.ICorDebugArrayValue WrappedObject
		{
			get
			{
		...
		public ICorDebugArrayValue(Interop.CorDebug.ICorDebugArrayValue wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(Wrappers.CorDebug.ICorDebugArrayValue));
		}
		
		public static Wrappers.CorDebug.ICorDebugArrayValue Wrap(Interop.CorDebug.ICorDebugArrayValue objectToWrap)
		{
			if ((objectToWrap != null))
			{
				return new Wrappers.CorDebug.ICorDebugArrayValue(objectToWrap);
			} else
			{
				return null;
			}
		...
		~ICorDebugArrayValue()
		{
			...
			wrappedObject = null;
			ResourceManager.ReleaseCOMObject(o, typeof(Wrappers.CorDebug.ICorDebugArrayValue));
		}
		...
		public static bool operator ==(Wrappers.CorDebug.ICorDebugArrayValue o1, Wrappers.CorDebug.ICorDebugArrayValue o2)
		{
		...
		{
			Wrappers.CorDebug.ICorDebugArrayValue casted = o as Wrappers.CorDebug.ICorDebugArrayValue;
