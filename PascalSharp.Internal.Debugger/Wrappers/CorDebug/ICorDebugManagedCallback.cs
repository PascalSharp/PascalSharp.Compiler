...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugManagedCallback
	{
		...
		private Interop.CorDebug.ICorDebugManagedCallback wrappedObject;
		
		internal Interop.CorDebug.ICorDebugManagedCallback WrappedObject
		{
			get
			{
		...
		public ICorDebugManagedCallback(Interop.CorDebug.ICorDebugManagedCallback wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugManagedCallback));
		}
		
		public static ICorDebugManagedCallback Wrap(Interop.CorDebug.ICorDebugManagedCallback objectToWrap)
		{
