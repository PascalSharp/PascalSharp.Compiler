...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugEnum
	{
		...
		private Interop.CorDebug.ICorDebugEnum wrappedObject;
		
		internal Interop.CorDebug.ICorDebugEnum WrappedObject
		{
			get
			{
		...
		public ICorDebugEnum(Interop.CorDebug.ICorDebugEnum wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugEnum));
		}
		
		public static ICorDebugEnum Wrap(Interop.CorDebug.ICorDebugEnum objectToWrap)
		{
