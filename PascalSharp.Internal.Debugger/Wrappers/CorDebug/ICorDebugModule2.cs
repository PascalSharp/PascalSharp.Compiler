...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugModule2
	{
		...
		private Interop.CorDebug.ICorDebugModule2 wrappedObject;
		
		internal Interop.CorDebug.ICorDebugModule2 WrappedObject
		{
			get
			{
		...
		public ICorDebugModule2(Interop.CorDebug.ICorDebugModule2 wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugModule2));
		}
		
		public static ICorDebugModule2 Wrap(Interop.CorDebug.ICorDebugModule2 objectToWrap)
		{
