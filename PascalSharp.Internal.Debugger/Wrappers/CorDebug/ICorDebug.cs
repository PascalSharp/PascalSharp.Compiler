...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebug
	{
		...
		private Interop.CorDebug.ICorDebug wrappedObject;
		
		internal Interop.CorDebug.ICorDebug WrappedObject
		{
			get
			{
		...
		public ICorDebug(Interop.CorDebug.ICorDebug wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebug));
		}
		
		public static ICorDebug Wrap(Interop.CorDebug.ICorDebug objectToWrap)
		{
