...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugModuleEnum
	{
		...
		private Interop.CorDebug.ICorDebugModuleEnum wrappedObject;
		
		internal Interop.CorDebug.ICorDebugModuleEnum WrappedObject
		{
			get
			{
		...
		public ICorDebugModuleEnum(Interop.CorDebug.ICorDebugModuleEnum wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugModuleEnum));
		}
		
		public static ICorDebugModuleEnum Wrap(Interop.CorDebug.ICorDebugModuleEnum objectToWrap)
		{
