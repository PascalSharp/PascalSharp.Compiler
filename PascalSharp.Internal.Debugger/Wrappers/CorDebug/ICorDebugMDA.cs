...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugMDA
	{
		...
		private Interop.CorDebug.ICorDebugMDA wrappedObject;
		
		internal Interop.CorDebug.ICorDebugMDA WrappedObject
		{
			get
			{
		...
		public ICorDebugMDA(Interop.CorDebug.ICorDebugMDA wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugMDA));
		}
		
		public static ICorDebugMDA Wrap(Interop.CorDebug.ICorDebugMDA objectToWrap)
		{
