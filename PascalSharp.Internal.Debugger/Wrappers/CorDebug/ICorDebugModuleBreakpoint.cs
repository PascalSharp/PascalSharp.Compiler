...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugModuleBreakpoint
	{
		...
		private Interop.CorDebug.ICorDebugModuleBreakpoint wrappedObject;
		
		internal Interop.CorDebug.ICorDebugModuleBreakpoint WrappedObject
		{
			get
			{
		...
		public ICorDebugModuleBreakpoint(Interop.CorDebug.ICorDebugModuleBreakpoint wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugModuleBreakpoint));
		}
		
		public static ICorDebugModuleBreakpoint Wrap(Interop.CorDebug.ICorDebugModuleBreakpoint objectToWrap)
		{
