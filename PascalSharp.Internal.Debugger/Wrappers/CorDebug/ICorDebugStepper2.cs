...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugStepper2
	{
		...
		private Interop.CorDebug.ICorDebugStepper2 wrappedObject;
		
		internal Interop.CorDebug.ICorDebugStepper2 WrappedObject
		{
			get
			{
		...
		public ICorDebugStepper2(Interop.CorDebug.ICorDebugStepper2 wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugStepper2));
		}
		
		public static ICorDebugStepper2 Wrap(Interop.CorDebug.ICorDebugStepper2 objectToWrap)
		{
