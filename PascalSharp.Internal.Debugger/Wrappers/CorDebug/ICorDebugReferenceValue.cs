...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugReferenceValue
	{
		...
		private Interop.CorDebug.ICorDebugReferenceValue wrappedObject;
		
		internal Interop.CorDebug.ICorDebugReferenceValue WrappedObject
		{
			get
			{
		...
		public ICorDebugReferenceValue(Interop.CorDebug.ICorDebugReferenceValue wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugReferenceValue));
		}
		
		public static ICorDebugReferenceValue Wrap(Interop.CorDebug.ICorDebugReferenceValue objectToWrap)
		{
