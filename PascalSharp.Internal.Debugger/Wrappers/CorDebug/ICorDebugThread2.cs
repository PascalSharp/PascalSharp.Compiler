...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugThread2
	{
		...
		private Interop.CorDebug.ICorDebugThread2 wrappedObject;
		
		internal Interop.CorDebug.ICorDebugThread2 WrappedObject
		{
			get
			{
		...
		public ICorDebugThread2(Interop.CorDebug.ICorDebugThread2 wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugThread2));
		}
		
		public static ICorDebugThread2 Wrap(Interop.CorDebug.ICorDebugThread2 objectToWrap)
		{
