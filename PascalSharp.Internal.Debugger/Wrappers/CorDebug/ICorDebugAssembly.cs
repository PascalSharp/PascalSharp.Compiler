...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugAssembly
	{
		...
		private Interop.CorDebug.ICorDebugAssembly wrappedObject;
		
		internal Interop.CorDebug.ICorDebugAssembly WrappedObject
		{
			get
			{
		...
		public ICorDebugAssembly(Interop.CorDebug.ICorDebugAssembly wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugAssembly));
		}
		
		public static ICorDebugAssembly Wrap(Interop.CorDebug.ICorDebugAssembly objectToWrap)
		{
		...
		public ICorDebugModuleEnum EnumerateModules()
		{
			...
			Interop.CorDebug.ICorDebugModuleEnum out_ppModules;
