...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugStepperEnum
	{
		...
		private Interop.CorDebug.ICorDebugStepperEnum wrappedObject;
		
		internal Interop.CorDebug.ICorDebugStepperEnum WrappedObject
		{
			get
			{
		...
		public ICorDebugStepperEnum(Interop.CorDebug.ICorDebugStepperEnum wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugStepperEnum));
		}
		
		public static ICorDebugStepperEnum Wrap(Interop.CorDebug.ICorDebugStepperEnum objectToWrap)
		{
