...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugClass2
	{
		...
		private Interop.CorDebug.ICorDebugClass2 wrappedObject;
		
		internal Interop.CorDebug.ICorDebugClass2 WrappedObject
		{
			get
			{
		...
		public ICorDebugClass2(Interop.CorDebug.ICorDebugClass2 wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugClass2));
		}
		
		public static ICorDebugClass2 Wrap(Interop.CorDebug.ICorDebugClass2 objectToWrap)
		{
