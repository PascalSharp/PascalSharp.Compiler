...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugValue
	{
		...
		private Interop.CorDebug.ICorDebugValue wrappedObject;
		
		internal Interop.CorDebug.ICorDebugValue WrappedObject
		{
			get
			{
		...
		public ICorDebugValue(Interop.CorDebug.ICorDebugValue wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugValue));
		}
		
		public static ICorDebugValue Wrap(Interop.CorDebug.ICorDebugValue objectToWrap)
		{
