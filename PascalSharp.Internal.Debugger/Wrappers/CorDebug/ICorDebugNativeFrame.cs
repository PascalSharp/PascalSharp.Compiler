...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugNativeFrame
	{
		...
		private Interop.CorDebug.ICorDebugNativeFrame wrappedObject;
		
		internal Interop.CorDebug.ICorDebugNativeFrame WrappedObject
		{
			get
			{
		...
		public ICorDebugNativeFrame(Interop.CorDebug.ICorDebugNativeFrame wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugNativeFrame));
		}
		
		public static ICorDebugNativeFrame Wrap(Interop.CorDebug.ICorDebugNativeFrame objectToWrap)
		{
