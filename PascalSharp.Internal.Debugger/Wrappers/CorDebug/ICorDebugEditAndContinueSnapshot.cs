...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugEditAndContinueSnapshot
	{
		...
		private Interop.CorDebug.ICorDebugEditAndContinueSnapshot wrappedObject;
		
		internal Interop.CorDebug.ICorDebugEditAndContinueSnapshot WrappedObject
		{
			get
			{
		...
		public ICorDebugEditAndContinueSnapshot(Interop.CorDebug.ICorDebugEditAndContinueSnapshot wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugEditAndContinueSnapshot));
		}
		
		public static ICorDebugEditAndContinueSnapshot Wrap(Interop.CorDebug.ICorDebugEditAndContinueSnapshot objectToWrap)
		{
		...
		public void SetILMap(uint mdFunction, uint cMapSize, ref _COR_IL_MAP map)
		{
