...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugRegisterSet
	{
		...
		private Interop.CorDebug.ICorDebugRegisterSet wrappedObject;
		
		internal Interop.CorDebug.ICorDebugRegisterSet WrappedObject
		{
			get
			{
		...
		public ICorDebugRegisterSet(Interop.CorDebug.ICorDebugRegisterSet wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugRegisterSet));
		}
		
		public static ICorDebugRegisterSet Wrap(Interop.CorDebug.ICorDebugRegisterSet objectToWrap)
		{
