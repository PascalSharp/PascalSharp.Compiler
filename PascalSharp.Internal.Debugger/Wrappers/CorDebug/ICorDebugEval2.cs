...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugEval2
	{
		...
		private Interop.CorDebug.ICorDebugEval2 wrappedObject;
		
		internal Interop.CorDebug.ICorDebugEval2 WrappedObject
		{
			get
			{
		...
		public ICorDebugEval2(Interop.CorDebug.ICorDebugEval2 wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugEval2));
		}
		
		public static ICorDebugEval2 Wrap(Interop.CorDebug.ICorDebugEval2 objectToWrap)
		{
