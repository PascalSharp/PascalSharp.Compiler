...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugHeapValue
	{
		...
		private Interop.CorDebug.ICorDebugHeapValue wrappedObject;
		
		internal Interop.CorDebug.ICorDebugHeapValue WrappedObject
		{
			get
			{
		...
		public ICorDebugHeapValue(Interop.CorDebug.ICorDebugHeapValue wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugHeapValue));
		}
		
		public static ICorDebugHeapValue Wrap(Interop.CorDebug.ICorDebugHeapValue objectToWrap)
		{
