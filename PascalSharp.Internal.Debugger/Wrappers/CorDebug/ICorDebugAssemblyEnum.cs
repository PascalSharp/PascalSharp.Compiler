...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugAssemblyEnum
	{
		...
		private Interop.CorDebug.ICorDebugAssemblyEnum wrappedObject;
		
		internal Interop.CorDebug.ICorDebugAssemblyEnum WrappedObject
		{
			get
			{
		...
		public ICorDebugAssemblyEnum(Interop.CorDebug.ICorDebugAssemblyEnum wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugAssemblyEnum));
		}
		
		public static ICorDebugAssemblyEnum Wrap(Interop.CorDebug.ICorDebugAssemblyEnum objectToWrap)
		{
