...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugCode
	{
		...
		private Interop.CorDebug.ICorDebugCode wrappedObject;
		
		internal Interop.CorDebug.ICorDebugCode WrappedObject
		{
			get
			{
		...
		public ICorDebugCode(Interop.CorDebug.ICorDebugCode wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugCode));
		}
		
		public static ICorDebugCode Wrap(Interop.CorDebug.ICorDebugCode objectToWrap)
		{
