...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugBoxValue
	{
		...
		private Interop.CorDebug.ICorDebugBoxValue wrappedObject;
		
		internal Interop.CorDebug.ICorDebugBoxValue WrappedObject
		{
			get
			{
		...
		public ICorDebugBoxValue(Interop.CorDebug.ICorDebugBoxValue wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugBoxValue));
		}
		
		public static ICorDebugBoxValue Wrap(Interop.CorDebug.ICorDebugBoxValue objectToWrap)
		{
		...
		public ICorDebugObjectValue Object
		{
			get
			{
				...
				Interop.CorDebug.ICorDebugObjectValue out_ppObject;
