...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugProcess2
	{
		...
		private Interop.CorDebug.ICorDebugProcess2 wrappedObject;
		
		internal Interop.CorDebug.ICorDebugProcess2 WrappedObject
		{
			get
			{
		...
		public ICorDebugProcess2(Interop.CorDebug.ICorDebugProcess2 wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugProcess2));
		}
		
		public static ICorDebugProcess2 Wrap(Interop.CorDebug.ICorDebugProcess2 objectToWrap)
		{
		...
		public ICorDebugReferenceValue GetReferenceValueFromGCHandle(uint handle)
		{
			...
			Interop.CorDebug.ICorDebugReferenceValue out_pOutValue;
