...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugAppDomain2
	{
		...
		private Interop.CorDebug.ICorDebugAppDomain2 wrappedObject;
		
		internal Interop.CorDebug.ICorDebugAppDomain2 WrappedObject
		{
			get
			{
		...
		public ICorDebugAppDomain2(Interop.CorDebug.ICorDebugAppDomain2 wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugAppDomain2));
		}
		
		public static ICorDebugAppDomain2 Wrap(Interop.CorDebug.ICorDebugAppDomain2 objectToWrap)
		{
		...
		public ICorDebugType GetArrayOrPointerType(uint elementType, uint nRank, ICorDebugType pTypeArg)
		{
			...
			Interop.CorDebug.ICorDebugType out_ppType;
		...
		{
			ICorDebugType ppType;
			Interop.CorDebug.ICorDebugType ref_ppTypeArgs = ppTypeArgs.WrappedObject;
			Interop.CorDebug.ICorDebugType out_ppType;
