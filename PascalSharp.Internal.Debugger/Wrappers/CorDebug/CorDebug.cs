...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class CorDebug
	{
		...
		private Interop.CorDebug.CorDebug wrappedObject;
		
		internal Interop.CorDebug.CorDebug WrappedObject
		{
			get
			{
		...
		public CorDebug(Interop.CorDebug.CorDebug wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorDebug));
		}
		
		public static CorDebug Wrap(Interop.CorDebug.CorDebug objectToWrap)
		{
