...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugAppDomainEnum
	{
		...
		private Interop.CorDebug.ICorDebugAppDomainEnum wrappedObject;
		
		internal Interop.CorDebug.ICorDebugAppDomainEnum WrappedObject
		{
			get
			{
		...
		public ICorDebugAppDomainEnum(Interop.CorDebug.ICorDebugAppDomainEnum wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugAppDomainEnum));
		}
		
		public static ICorDebugAppDomainEnum Wrap(Interop.CorDebug.ICorDebugAppDomainEnum objectToWrap)
		{
