...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugManagedCallback2
	{
		...
		private Interop.CorDebug.ICorDebugManagedCallback2 wrappedObject;
		
		internal Interop.CorDebug.ICorDebugManagedCallback2 WrappedObject
		{
			get
			{
		...
		public ICorDebugManagedCallback2(Interop.CorDebug.ICorDebugManagedCallback2 wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugManagedCallback2));
		}
		
		public static ICorDebugManagedCallback2 Wrap(Interop.CorDebug.ICorDebugManagedCallback2 objectToWrap)
		{
