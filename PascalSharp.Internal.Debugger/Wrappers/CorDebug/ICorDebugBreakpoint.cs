...
namespace PascalSharp.Internal.Debugger.Wrappers.CorDebug
{
    public partial class ICorDebugBreakpoint
	{
		...
		private Interop.CorDebug.ICorDebugBreakpoint wrappedObject;
		
		internal Interop.CorDebug.ICorDebugBreakpoint WrappedObject
		{
			get
			{
		...
		public ICorDebugBreakpoint(Interop.CorDebug.ICorDebugBreakpoint wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ICorDebugBreakpoint));
		}
		
		public static ICorDebugBreakpoint Wrap(Interop.CorDebug.ICorDebugBreakpoint objectToWrap)
		{
