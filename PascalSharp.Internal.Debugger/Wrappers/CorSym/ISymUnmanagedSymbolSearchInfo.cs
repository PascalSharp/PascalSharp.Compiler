...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class ISymUnmanagedSymbolSearchInfo
	{
		...
		private Interop.CorSym.ISymUnmanagedSymbolSearchInfo wrappedObject;
		
		internal Interop.CorSym.ISymUnmanagedSymbolSearchInfo WrappedObject
		{
			get
			{
		...
		public ISymUnmanagedSymbolSearchInfo(Interop.CorSym.ISymUnmanagedSymbolSearchInfo wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ISymUnmanagedSymbolSearchInfo));
		}
		
		public static ISymUnmanagedSymbolSearchInfo Wrap(Interop.CorSym.ISymUnmanagedSymbolSearchInfo objectToWrap)
		{
