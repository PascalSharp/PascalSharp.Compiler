...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class ISequentialStream
	{
		...
		private Interop.CorSym.ISequentialStream wrappedObject;
		
		internal Interop.CorSym.ISequentialStream WrappedObject
		{
			get
			{
		...
		public ISequentialStream(Interop.CorSym.ISequentialStream wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ISequentialStream));
		}
		
		public static ISequentialStream Wrap(Interop.CorSym.ISequentialStream objectToWrap)
		{
