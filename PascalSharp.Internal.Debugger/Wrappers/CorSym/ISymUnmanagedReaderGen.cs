...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class ISymUnmanagedReader
	{
		...
		private Interop.CorSym.ISymUnmanagedReader wrappedObject;
		
		internal Interop.CorSym.ISymUnmanagedReader WrappedObject
		{
			get
			{
		...
		public ISymUnmanagedReader(Interop.CorSym.ISymUnmanagedReader wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorSym.ISymUnmanagedReader));
		}
		
		public static CorSym.ISymUnmanagedReader Wrap(Interop.CorSym.ISymUnmanagedReader objectToWrap)
		{
			if ((objectToWrap != null))
			{
				return new CorSym.ISymUnmanagedReader(objectToWrap);
			} else
			{
				return null;
			}
		...
		~ISymUnmanagedReader()
		{
			...
			wrappedObject = null;
			ResourceManager.ReleaseCOMObject(o, typeof(CorSym.ISymUnmanagedReader));
		}
		...
		public static bool operator ==(CorSym.ISymUnmanagedReader o1, CorSym.ISymUnmanagedReader o2)
		{
		...
		{
			CorSym.ISymUnmanagedReader casted = o as CorSym.ISymUnmanagedReader;
