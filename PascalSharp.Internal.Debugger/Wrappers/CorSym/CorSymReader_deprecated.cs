...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class CorSymReader_deprecated
	{
		...
		private Interop.CorSym.CorSymReader_deprecated wrappedObject;
		
		internal Interop.CorSym.CorSymReader_deprecated WrappedObject
		{
			get
			{
		...
		public CorSymReader_deprecated(Interop.CorSym.CorSymReader_deprecated wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorSymReader_deprecated));
		}
		
		public static CorSymReader_deprecated Wrap(Interop.CorSym.CorSymReader_deprecated objectToWrap)
		{
