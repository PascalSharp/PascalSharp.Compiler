...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class CorSymBinder_SxSClass
	{
		...
		private Interop.CorSym.CorSymBinder_SxSClass wrappedObject;
		
		internal Interop.CorSym.CorSymBinder_SxSClass WrappedObject
		{
			get
			{
		...
		public CorSymBinder_SxSClass(Interop.CorSym.CorSymBinder_SxSClass wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorSymBinder_SxSClass));
		}
		
		public static CorSymBinder_SxSClass Wrap(Interop.CorSym.CorSymBinder_SxSClass objectToWrap)
		{
