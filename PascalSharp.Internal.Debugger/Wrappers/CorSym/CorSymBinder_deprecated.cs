...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class CorSymBinder_deprecated
	{
		...
		private Interop.CorSym.CorSymBinder_deprecated wrappedObject;
		
		internal Interop.CorSym.CorSymBinder_deprecated WrappedObject
		{
			get
			{
		...
		public CorSymBinder_deprecated(Interop.CorSym.CorSymBinder_deprecated wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorSymBinder_deprecated));
		}
		
		public static CorSymBinder_deprecated Wrap(Interop.CorSym.CorSymBinder_deprecated objectToWrap)
		{
