...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class CorSymBinder_SxS
	{
		...
		private Interop.CorSym.CorSymBinder_SxS wrappedObject;
		
		internal Interop.CorSym.CorSymBinder_SxS WrappedObject
		{
			get
			{
		...
		public CorSymBinder_SxS(Interop.CorSym.CorSymBinder_SxS wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorSymBinder_SxS));
		}
		
		public static CorSymBinder_SxS Wrap(Interop.CorSym.CorSymBinder_SxS objectToWrap)
		{
