...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class CorSymReader_deprecatedClass
	{
		...
		private Interop.CorSym.CorSymReader_deprecatedClass wrappedObject;
		
		internal Interop.CorSym.CorSymReader_deprecatedClass WrappedObject
		{
			get
			{
		...
		public CorSymReader_deprecatedClass(Interop.CorSym.CorSymReader_deprecatedClass wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorSymReader_deprecatedClass));
		}
		
		public static CorSymReader_deprecatedClass Wrap(Interop.CorSym.CorSymReader_deprecatedClass objectToWrap)
		{
