...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class IStream
	{
		...
		private Interop.CorSym.IStream wrappedObject;
		
		internal Interop.CorSym.IStream WrappedObject
		{
			get
			{
		...
		public IStream(Interop.CorSym.IStream wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(IStream));
		}
		
		public static IStream Wrap(Interop.CorSym.IStream objectToWrap)
		{
		...
		{
			IStream ppstm;
			Interop.CorSym.IStream out_ppstm;
