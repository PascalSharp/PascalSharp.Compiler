...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class CorSymWriter_SxSClass
	{
		...
		private Interop.CorSym.CorSymWriter_SxSClass wrappedObject;
		
		internal Interop.CorSym.CorSymWriter_SxSClass WrappedObject
		{
			get
			{
		...
		public CorSymWriter_SxSClass(Interop.CorSym.CorSymWriter_SxSClass wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorSymWriter_SxSClass));
		}
		
		public static CorSymWriter_SxSClass Wrap(Interop.CorSym.CorSymWriter_SxSClass objectToWrap)
		{
