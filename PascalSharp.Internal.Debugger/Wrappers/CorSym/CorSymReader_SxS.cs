...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class CorSymReader_SxS
	{
		...
		private Interop.CorSym.CorSymReader_SxS wrappedObject;
		
		internal Interop.CorSym.CorSymReader_SxS WrappedObject
		{
			get
			{
		...
		public CorSymReader_SxS(Interop.CorSym.CorSymReader_SxS wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorSymReader_SxS));
		}
		
		public static CorSymReader_SxS Wrap(Interop.CorSym.CorSymReader_SxS objectToWrap)
		{
