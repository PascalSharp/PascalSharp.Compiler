...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class CorSymWriter_deprecatedClass
	{
		...
		private Interop.CorSym.CorSymWriter_deprecatedClass wrappedObject;
		
		internal Interop.CorSym.CorSymWriter_deprecatedClass WrappedObject
		{
			get
			{
		...
		public CorSymWriter_deprecatedClass(Interop.CorSym.CorSymWriter_deprecatedClass wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorSymWriter_deprecatedClass));
		}
		
		public static CorSymWriter_deprecatedClass Wrap(Interop.CorSym.CorSymWriter_deprecatedClass objectToWrap)
		{
