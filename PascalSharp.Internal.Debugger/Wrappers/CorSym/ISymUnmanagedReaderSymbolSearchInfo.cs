...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class ISymUnmanagedReaderSymbolSearchInfo
	{
		...
		private Interop.CorSym.ISymUnmanagedReaderSymbolSearchInfo wrappedObject;
		
		internal Interop.CorSym.ISymUnmanagedReaderSymbolSearchInfo WrappedObject
		{
			get
			{
		...
		public ISymUnmanagedReaderSymbolSearchInfo(Interop.CorSym.ISymUnmanagedReaderSymbolSearchInfo wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ISymUnmanagedReaderSymbolSearchInfo));
		}
		
		public static ISymUnmanagedReaderSymbolSearchInfo Wrap(Interop.CorSym.ISymUnmanagedReaderSymbolSearchInfo objectToWrap)
		{
		...
		public ISymUnmanagedSymbolSearchInfo GetSymbolSearchInfo(uint cSearchInfo, out uint pcSearchInfo)
		{
			...
			Interop.CorSym.ISymUnmanagedSymbolSearchInfo out_rgpSearchInfo;
