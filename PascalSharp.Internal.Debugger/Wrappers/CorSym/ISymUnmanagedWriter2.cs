...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class ISymUnmanagedWriter2
	{
		...
		private Interop.CorSym.ISymUnmanagedWriter2 wrappedObject;
		
		internal Interop.CorSym.ISymUnmanagedWriter2 WrappedObject
		{
			get
			{
		...
		public ISymUnmanagedWriter2(Interop.CorSym.ISymUnmanagedWriter2 wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ISymUnmanagedWriter2));
		}
		
		public static ISymUnmanagedWriter2 Wrap(Interop.CorSym.ISymUnmanagedWriter2 objectToWrap)
		{
