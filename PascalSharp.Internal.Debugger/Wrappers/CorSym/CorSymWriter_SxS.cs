...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class CorSymWriter_SxS
	{
		...
		private Interop.CorSym.CorSymWriter_SxS wrappedObject;
		
		internal Interop.CorSym.CorSymWriter_SxS WrappedObject
		{
			get
			{
		...
		public CorSymWriter_SxS(Interop.CorSym.CorSymWriter_SxS wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(CorSymWriter_SxS));
		}
		
		public static CorSymWriter_SxS Wrap(Interop.CorSym.CorSymWriter_SxS objectToWrap)
		{
