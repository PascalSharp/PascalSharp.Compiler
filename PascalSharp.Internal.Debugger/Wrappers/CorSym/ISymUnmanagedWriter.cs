...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class ISymUnmanagedWriter
	{
		...
		private Interop.CorSym.ISymUnmanagedWriter wrappedObject;
		
		internal Interop.CorSym.ISymUnmanagedWriter WrappedObject
		{
			get
			{
		...
		public ISymUnmanagedWriter(Interop.CorSym.ISymUnmanagedWriter wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ISymUnmanagedWriter));
		}
		
		public static ISymUnmanagedWriter Wrap(Interop.CorSym.ISymUnmanagedWriter objectToWrap)
		{
