...
namespace PascalSharp.Internal.Debugger.Wrappers.CorSym
{
    public partial class ISymUnmanagedDocumentWriter
	{
		...
		private Interop.CorSym.ISymUnmanagedDocumentWriter wrappedObject;
		
		internal Interop.CorSym.ISymUnmanagedDocumentWriter WrappedObject
		{
			get
			{
		...
		public ISymUnmanagedDocumentWriter(Interop.CorSym.ISymUnmanagedDocumentWriter wrappedObject)
		{
			this.wrappedObject = wrappedObject;
			ResourceManager.TrackCOMObject(wrappedObject, typeof(ISymUnmanagedDocumentWriter));
		}
		
		public static ISymUnmanagedDocumentWriter Wrap(Interop.CorSym.ISymUnmanagedDocumentWriter objectToWrap)
		{
